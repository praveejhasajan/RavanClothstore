...
})(
  {
    ...
    10: [
      function (t, n, e) {
        function r(t) {
          if (t.info.beacon) {
            t.info.queueTime &&
              E.store("measures", "qt", { value: t.info.queueTime }),
              t.info.applicationTime &&
                E.store("measures", "ap", { value: t.info.applicationTime }),
            ...
            if (e) {
              ...
              if (
                (i.push(e),
                i.push(x.param("tt", t.info.ttGuid)),
                i.push(x.param("us", t.info.user)),
                i.push(x.param("ac", t.info.account)),
                i.push(x.param("pr", t.info.product)),
                i.push(
                  x.param(
                    "af",
                ...
                a &&
                  ...
                  a.forEach(function (t) {
                    !t.startTime ||
                      t.startTime <= 0 ||
                      ("first-paint" === t.name
                        ? i.push(x.param("fp", String(Math.floor(t.startTime))))
                        : "first-contentful-paint" === t.name &&
                          i.push(
                            x.param("fcp", String(Math.floor(t.startTime)))
                          ),
                      F(t.name, Math.floor(t.startTime)));
                  });
              }
              i.push(x.param("xx", t.info.extra)),
                i.push(x.param("ua", t.info.userAttributes)),
                i.push(x.param("at", t.info.atts));
        ...
        function c(t, n, e, r, i, o) {
          ...
          return (
            l ||
              u !== b.beacon ||
              ((u = b.img), (l = u(a + x.obj(e.body, n.maxBytes)))),
            l
          );
        }
        function f(t, n) {
        ...
        function d(t) {
          return t.info.transactionName
            ? x.param("to", t.info.transactionName)
            : x.param("t", t.info.tNamePlain || "Unnamed Transaction");
        }
        function l(t, n) {
          var e = N[t] || (N[t] = []);
          e.push(n);
        ...
        function p(t) {
          ...
          return (
            ...
            [
              ...
              x.param("sa", t.info.sa ? "" + t.info.sa : ""),
              x.param("v", A),
              d(t),
              x.param("ct", t.customTransaction),
              "&rst=" + t.now(),
              "&ck=" + (n ? "1" : "0"),
              x.param("ref", C(j.getLocation())),
              x.param("ptid", t.ptid ? "" + t.ptid : ""),
            ].join("")
          );
        }
        function m() {
    ...
    24: [
      function (t, n, e) {
        ...
        function a(t) {
          (t.startTime - F.lastEntryTime > 1e3 ||
            t.startTime - F.firstEntryTime > 5e3) &&
            (F = {
              value: 0,
            ...
            (F.value += t.value),
            (F.lastEntryTime = Math.max(F.lastEntryTime, t.startTime)),
            P < F.value && (P = F.value);
        }
        function s(t) {
        ...
        var g = t(4).nullable,
          ...
          I = !1,
          P = 0,
          F = { value: 0, firstEntryTime: 0, lastEntryTime: 0 },
          O = !1;
        n.exports = {
          addTiming: c,
          getPayload: m,
      ...
      function (t, n, e) {
          ...
          return t.ignored || (!t.save && !t.routeChange)
            ...
            : ((t.root.attrs.id = U.generateUuid()),
              "initialPageLoad" === t.root.attrs.trigger &&
                ((t.root.attrs.firstPaint = L["first-paint"]),
        ...
        (n.exports = function () {
          ...
          w.on("feat-spa", function () {
            ...
            if (l()) {
              (st = new I("initialPageLoad", 0, tt, nt, s)),
                (st.save = !0),
                (it = st.root),
                st[D]++,
                h.on(w, q, t),
              ...
              h("spa-register", function (t) {
                ...
                h.on(C, Z, function () {
                  ...
                  if (t) {
                    ...
                    (e.method = "GET"),
                      ...
                      (n.isJSONP = !0),
                      (t.jsEnd = this[Z]),
                      (t.jsTime = this[B] ? this[Z] - this[B] : 0),
                      t.finish(t.jsEnd);
                  }
                }),
                h.on(k, X, function (t, n) {
                  it &&
                    t &&
                    ((this[V] = it.child("ajax", this[X])),
                    n && this[V] && (this[V].dt = n));
                }),
                ...
                C.on("dom-start", function (t) {
                  ...
                  if (it) {
                    ...
                    i &&
                      (o[D]++,
                      r.addEventListener("load", n, F(!1)),
                      r.addEventListener("error", e, F(!1)));
                  }
                }),
                h.on(b, q, function () {
                  a(ot);
                ...
                h(z + "tracer", function (t, n, e) {
                  var r = this.ixn,
                    ...
                    o = w.context(e);
                  return n
                    ? void (o[V] = i.child("customTracer", t, n))
                    : ((o.inc = ++r[D]), (o[V] = i));
                }),
                h.on(R, q, e),
                h.on(R, "no-" + q, e),
      ...
      function (t, n, e) {
        ...
        if (j.xhrUsable && E.xhrWrappable) {
          var I = "",
            ...
            D = t("ee");
          if (((n.exports = { _takeSTNs: m }), t(20), E.features.stn)) {
            D.on("feat-stn", function () {
              function t(t) {
                t.sent &&
                  t.responseText &&
                  !I &&
                  ((I = t.responseText), (E.ptid = I), e.startTimer(B)),
                  t.sent &&
                    t.retry &&
                    H &&
                    (C(H, function (t, n) {
    ...
    39: [
      function (t, n, e) {
        ...
        function o(t) {
          ...
          for (
            var n = a(N, t.maxPayloadSize || I), e = [], r = 0;
            r < n.length;
            r++
          )
            e.push({ body: { e: n[r] } });
      ...
      function (t, n, e) {
        ...
        function a(t) {
          ...
          i &&
            i.getRandomValues &&
            Uint8Array &&
            (e = i.getRandomValues(new Uint8Array(31)));
